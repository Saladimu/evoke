...
// .wrangler/tmp/pages-8A1rNl/functionsWorker-0.2153341420505639.mjs
var __defProp2 = Object.defineProperty;
var __name2 = /* @__PURE__ */ __name((target, value) => __defProp2(target, "name", { value, configurable: true }), "__name");
var SHEET_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vSEIhSXJGhIrmUPcj2vWWnZHagsQnkm9-BBBr1tdmmWiCKB0OvYqkBCiRIpHO_f_tpJfTW8YjCtu4vt/pub?gid=470675989&single=true&output=csv";
var KELAS = ["SD", "SMP", "SMA", "Gabungan"];
...
__name(rowToObject, "rowToObject");
__name2(rowToObject, "rowToObject");
async function onRequest(context) {
  try {
    ...
    const pending = records.filter(
      (r) => r["Pemenang"] === "" && r["Tim-1"] !== "" && r["Tim-2"] !== ""
    );
    const totalLomba = records.filter(
      (r) => r["Tanggal"] !== "" && r["Pemenang"] !== "" && r["Internal"].toUpperCase() === "TRUE"
    );
    const totalCount = {};
    const winners = {};
    KELAS.forEach((k) => {
...
// .wrangler/tmp/bundle-anhoWj/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-anhoWj/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.2153341420505639.js.map
